...
# mssql
# boundary connect -target-id ttcp_5BlfvprSsq -listen-port 1443 & \  
# access-management-service
# boundary connect -target-id ttcp_UQc4bK4AAW -listen-port 8091 & \

# export DB_URL="jdbc:h2:mem:certificatemgmt;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;MODE=MSSQLServer;DATABASE_TO_UPPER=FALSE;CASE_INSENSITIVE_IDENTIFIERS=TRUE"
# export DB_DRIVER_CLASSNAME="org.h2.Driver"
...
export PERMISSION_SERVICE_ENDPOINT="http://localhost:8091/graphql"
