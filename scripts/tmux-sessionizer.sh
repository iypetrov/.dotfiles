...
target="$(find "/home/ipetrov/projects/common" "/home/ipetrov/projects/personal" "/home/ipetrov/projects/ip812" "/home/ipetrov/projects/avalon" "/home/ipetrov/projects/work" -mindepth 1 -maxdepth 1 -type d | fzf)"
if [[ -z $"{target}" ]]; then
    exit 0
fi
